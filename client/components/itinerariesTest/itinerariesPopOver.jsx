          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="relative flex items-center justify-center py-5 lg:justify-between">
              ...
              <div className="absolute right-0 flex-shrink-0 lg:hidden z-10">
                {/* Mobile menu button */}
                <Popover.Button className="relative inline-flex items-center justify-center rounded-md bg-transparent p-2 text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white focus:outline-none focus:ring-2 focus:ring-white z-20">
                  <span className="sr-only">Open main menu</span>
                  {open ? (
                    <XMarkIcon className="block h-32 w-32" aria-hidden="true" />
                  ) : (
                    <Bars3Icon className="block h-32 w-32" aria-hidden="true" />
                  )}
                </Popover.Button>
              </div>
            </div>
