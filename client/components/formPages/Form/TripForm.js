        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-6 grid grid-cols-2 gap-4">
                    {/* From and To */}
                    <div>
                        <label htmlFor="fromLocation" className="block text-sm font-medium text-gray-800 mb-2">From:</label>
                        <input
                            id="fromLocation"
                            type="text"
                            value={fromLocation}
                    ...
                    <div>
                        <label htmlFor="destination" className="block text-sm font-medium text-gray-800 mb-2">To:</label>
                        <input
                            id="destination"
                            type="text"
                            value={destination}
                ...
                <div className="mb-6 grid grid-cols-2 gap-4">
                    <div>
                        <label htmlFor="startDate" className="block text-sm font-medium text-gray-800 mb-2">Start Date:</label>
                        <input
                            id="startDate"
                            type="date"
                            value={startDate}
                    ...
                    <div>
                        <label htmlFor="endDate" className="block text-sm font-medium text-gray-800 mb-2">End Date:</label>
                        <input
                            id="endDate"
                            type="date"
                            value={endDate}
                ...
                <div className="mb-6 grid grid-cols-2 gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-800 mb-2">Travelers:</label>
                    ...
                    {/* Group */}
                    <div>
                        <label htmlFor="groupDescription" className="block text-sm font-medium text-gray-800 mb-2">Group:</label>
                        <select
                            id="groupDescription"
